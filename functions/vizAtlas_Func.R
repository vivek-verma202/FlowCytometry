vizAtlas_Func=function(CellMat,Build,FuncMat,Y,ToUse,SampsToUse=NULL,numCore,layout,outDir,FuncNames,numIter){
  #description:
  ...
  for(is in 1:length(FuncNames)){
    ...
    FName=paste(FuncNames[is],'_direction_pval.jpg',sep='')

RunCl_Flow=function(S,K,FileNames,doCPF=c('auto','specify'),numCPF=NULL,MN,transformInds,ToUse,numCore){
...
#Inputs:
	...
	#FileNames: The full path for the file names (e.g. c('File1.fcs','File2.fcs'))
	#doCPF: whether or not to choose the number of clusters per file automatically or specify
	#numCPF: number of clusters per file. Leave as NULL if doCPF='auto'
	#MN: The names of markers (measured CyTOF parameters) corresponding to columns of FCS files
	#transformInds: the indices to transform
	#ToUse: the indices corresponding to the markers to be used for clustering
...
cytoftrans=arcsinhTransform(transformationId='cytofTransform',a=0,b=(1/200),c=0)

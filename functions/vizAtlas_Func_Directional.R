vizAtlas_Func_Directional=function(CellMat,Build,FuncMat,Y,ToUse,SampsToUse=NULL,numCore,layout,outDir,FuncNames,numIter){
...
FName=paste(FuncNames[is],'_func_directn.jpg',sep='')
